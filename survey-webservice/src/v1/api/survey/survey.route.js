...
router.put('/surveys/:id/addOrUpdateQuestion', auth, isCoordinator, surveyCtrl.addOrUpdateQuestion, response);
router.delete('/surveys/:id/removeQuestion/:questionId', auth, isCoordinator, surveyCtrl.removeQuestion, response);
router.put('/surveys/:id/questions/:questionId/response', auth, surveyCtrl.response, response);
